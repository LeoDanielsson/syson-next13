      ...
      <main>
        <IntroSection title="Fokus på dig" emoji={woman}>
          ...
          <p>
            ...
            Att jobba 8 timmar om dagen och sen kunna tänka på annat ser vi som
            en självklarhet.
          </p>
        </IntroSection>
        <People />
        ...
        <section>
          <div className="container">
            <h2>
              En schysst deal <Emoji image={handshake} />
            </h2>
            <p>
            ...
            <p>
              ...
              friheten att ta mer om du vill. Vill du ha en tjänstebil, spara
              mer pengar till pensionen eller något annat så hjälper vi dig med
              det.
            </p>
