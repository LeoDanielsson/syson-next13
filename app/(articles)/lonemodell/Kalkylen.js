...
class Kalkylen extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getTotalPension = () =>
    DEFAULT_VALUES.DEFAULT_PENSION + this.state.extraPension;
        ...
        <div className={styles.inputContainer}>
          <div className={styles.inputs}>
            <div>
              ...
              />
              <label className={classNames(styles.label, styles.labelSmall)}>
                Ditt pris mot kund
              </label>
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                type="number"
                value={this.state.extraVacationDays}
                className={classNames(styles.input)}
                onChange={this.handleInputChange}
                onFocus={this.handleFocus}
              />
            ...
            <div>
              ...
              <input
                ...
                type="number"
                value={this.state.otherMonthlyCosts}
                className={styles.input}
                onChange={this.handleInputChange}
                onFocus={this.handleFocus}
              />
